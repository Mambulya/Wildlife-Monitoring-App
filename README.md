...
There is a web-service that offers you to upload photos from camera traps and automatically detect wild animals with the following statistical information. The system is trained by ten sepecies describing Volgo-Kamsky Reserve: a lynx, bear, boar, fox, kelp gull, hare, badger, row deer, moose, squirrel.
